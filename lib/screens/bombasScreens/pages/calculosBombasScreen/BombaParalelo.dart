...
class BombaParalelo extends StatefulWidget {
  final String title;
  ...
  @override
  _BombaParaleloState createState() => _BombaParaleloState();
}

class _BombaParaleloState extends State<BombaParalelo> {
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  curvasIdentificador(Colors.pink, 'Bomba en Paralelo'),
                  SizedBox(
                    height: 8,
                  ),
                  buildResultRow(
