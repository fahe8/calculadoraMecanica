      ...
      appBar: MyAppBar(
          ...
          body: Padding(
            ...
            child: Column(
              ...
              SizedBox(height: 10),
              RectangleBombas(color: Colors.green.shade300, text: 'Bombas en serie'),
              SizedBox(height: 10),
              RectangleBombas(color: Colors.purple.shade300, text: 'Bombas en serie'),
              SizedBox(height: 10),
              RectangleBombas(color: Colors.orange.shade300, text: 'Bombas en serie'),
              SizedBox(height: 10),
            ],),
          ),
    );
